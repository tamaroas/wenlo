...
const Billings = () => {
  ...
  return (
    <>
      {isTopupPopupVisible ? <PopupRequestSummary handleClose={() => setIsTopupPopupVisible(false)}/> : null}
      {isDownloadPopupVisible ? <DownloadInvoicePopup handleClose={() => setIsDownloadPopupVisible(false)}/> : null}
      {isRequestPopupVisible ? <RequestSummaryPopup2 handleClose={() => setIsRequestPopupVisible(false)}/> : null}
